report 50104 "Aged Accounts Payable IT"
{
    DefaultLayout = RDLC;
    RDLCLayout = '.\Layout Reports Rdls\AgedAccountsPayable.rdlc';
    ApplicationArea = Basic, Suite;
    Caption = 'Aged Accounts Payable IT';
    ...
    dataset
    {
                ...
                dataitem(TempVendortLedgEntryLoop; "Integer")
                {
                    ...
                    begin
                        ...
                        if AdditionalCurrency <> '' then begin
                            ...
                            AdditionalBalanceCaption := StrSubstNo('Balance (%1)', AdditionalCurrency);
                            if CurrencyExchangeRate.Get(AdditionalCurrency, VendorLedgEntryEndingDate."Posting Date") then
                        ...
                        if AdditionalCurrency <> '' then begin
                            Clear(CurrencyExchangeRate);
                            AdditionalBalanceCaption := StrSubstNo('Balance (%1)', AdditionalCurrency);
                            AdditionalCurrencyRemAmt := CurrencyExchangeRate.ExchangeAmount(VendorLedgEntryEndingDate."Remaining Amt. (LCY)", GLSetup."LCY Code", GLSetup."Additional Reporting Currency", VendorLedgEntryEndingDate."Posting Date");
                            AdditionalCurrencyAmt += CurrencyExchangeRate.ExchangeAmount(VendorLedgEntryEndingDate."Remaining Amt. (LCY)", GLSetup."LCY Code", GLSetup."Additional Reporting Currency", VendorLedgEntryEndingDate."Posting Date");
                            TotalAdditionalCurrencyAmt += CurrencyExchangeRate.ExchangeAmount(VendorLedgEntryEndingDate."Remaining Amt. (LCY)", GLSetup."LCY Code", GLSetup."Additional Reporting Currency", VendorLedgEntryEndingDate."Posting Date");
                        end else begin
                            AdditionalBalanceCaption := StrSubstNo('Balance (%1)', GLSetup."LCY Code");
                            AdditionalCurrencyRemAmt := VendorLedgEntryEndingDate."Remaining Amt. (LCY)";
                            AdditionalCurrencyAmt += VendorLedgEntryEndingDate."Remaining Amt. (LCY)";
                            TotalAdditionalCurrencyAmt += VendorLedgEntryEndingDate."Remaining Amt. (LCY)";
                        end;
                    end;
        ...
        dataitem(CurrencyTotals; "Integer")
        {
            ...
            column(AgedVendLedgEnt6RemAmtLCY5; AgedVendorLedgEntry[5]."Remaining Amount")
            {//
                AutoFormatExpression = CurrencyCode;
                AutoFormatType = 1;
            }
                ...
                if TempCurrencyAmount.FindSet(false, false) then
                    repeat
                        if TempCurrencyAmount.Date <> DMY2Date(31, 12, 9999) then
                            ...
                            AgedVendorLedgEntry[5]."Remaining Amount" := TempCurrencyAmount.Amount;
                    //
    ...
    var
        ...
        TotalVendorLedgEntry: array[4] of Record "Vendor Ledger Entry";
        AgedVendorLedgEntry: array[5] of Record "Vendor Ledger Entry";
        TempCurrency: Record Currency temporary;
        TempCurrency2: Record Currency temporary;
        TempCurrencyAmount: Record "Currency Amount" temporary;
        DetailedVendorLedgerEntry: Record "Detailed Vendor Ledg. Entry";
        TypeHelper: Codeunit "Type Helper";
        GrandTotalVLERemaingAmtLCY: array[4] of Decimal;
