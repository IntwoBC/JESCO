report 50111 "Jesco Purchase - Receipt"
{
    ...
    begin
        FormatDocument.SetPurchaser(SalesPurchPerson, "Purch. Rcpt. Header"."Purchaser Code", PurchaserText);

        ReferenceText := FormatDocument.SetText("Purch. Rcpt. Header"."Your Reference" <> '', "Purch. Rcpt. Header".FieldCaption("Your Reference"));
    end;
